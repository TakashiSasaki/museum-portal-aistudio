(() => {
    ...
    async function ensureServiceWorker() {
        ...
        try {
            ...
            if (await canUseActiveWorker(fallback)) {
                console.warn('[ImagineDeck Bootstrap] Registration failed; using verified cached generation.', error);
                return true;
            }
            throw error;
        }
        ...
        try {
            ...
            if (await canUseActiveWorker(registration)) {
                console.warn('[ImagineDeck Bootstrap] Update failed; using verified cached generation.', error);
                return true;
            }
            throw error;
        }
